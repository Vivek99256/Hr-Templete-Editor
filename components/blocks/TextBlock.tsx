...
import { useEditor as useTiptapEditor, EditorContent, BubbleMenu } from "@tiptap/react";
...
export const TextBlock = ({
    ...
    return (
        <OverlayWrapper isOverlay={isOverlay} isText={true} x={x} y={y} width={width} height={height} rotation={rotation} zIndex={zIndex}>
            {editor && (
                <BubbleMenu editor={editor} tippyOptions={{ duration: 150, zIndex: 99999, maxWidth: "none", animation: 'scale' }}>
